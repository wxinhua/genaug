...
base_input_path="/nfsroot/DATA/IL_Research/datasets/real_franka_1/h5_data/241015_stack_blue_cube_on_pink_1/success_episodes"
...
trajectory_dirs=("${all_trajectory_dirs[@]:0:15}")
...
for run in {1..3}; do
    for input_dir in "${trajectory_dirs[@]}"; do
        ...
        for camera in "${cameras[@]}"; do
            ...
            # # 执行Python脚本
            CUDA_VISIBLE_DEVICES=0 python genaug_h5.py \
